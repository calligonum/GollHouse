...
<script type="text/javascript">
	$(document).ready(function(){
		...
		var point=new BMap.Point(103.996328,30.657796);
        ...
        <div class="collect">
            ...
            <!--基本数据-->
       		<div style="width:420px;float:left;">
                 <p class="title" style="width:422px;border-radius:5px 5px 0px 0px;">基本信息</p>
                    ...
                    <p><span class="in_span1">房源编号:</span><input type="text" name="h_number"><span id="h_number"></span></p>
                    ...
                    <%} %>
                    <p><span class="in_span1">房屋大小:</span><input type="text" name="h_proportion" maxlength="3"><span>平米</span><span id="h_proportion"></span></p>   
                    <p><span class="in_span1">所在楼层:</span><input type="text" name="h_floor" maxlength="2"><span>&nbsp;F</span><span id="h_floor"></span></p>				                
                    <p><span class="in_span1">共计楼层:</span><input type="text" name="h_all_floor" maxlength="2"><span>&nbsp;F</span><span id="h_all_floor"></span></p>
                    <p><span class="in_span1">租&nbsp;&nbsp;金:</span><input type="text" name="h_price" maxlength="3"><span>元/月</span><span id="h_price"></span></p> 
                    ...
                    %>
                    	<option value="<%=ht.getHt_id() %>"><%=ht.getHt_name() %></option>
                    <%} %>
                    </select></p> 
                    ...
                    %>
                    	<option value="<%=sa.getA_id()%>"><%=sa.getSa_name()%></option>
                    <%} %>
                    </select></p> 
                    ...
                    <%IPay_TypesService ptService=new Pay_TypesServiceImpl();
                     ...
                     %>
                     	<option value="<%=pt.getPt_id() %>"><%=pt.getPt_name()%></option>
                     <%} %>
                    </select></p> 
                </div>
            </div>
            ...
            <div class="maplist">
	          	<p class="title">地图定位:</p>
	          		<span  style="margin-left:10px;">经度</span><input type="text" name="h_xpoint" id="bd_x" style="width:100px;"/>
	          	<span>纬度</span><input type="text" name="h_ypoint" id="bd_y" style="width:100px;"/>
           ...
           <!-- 详情-->
        	...
        	<div class="information" style="height:420px;">
            	<p><span class="in_span1">房屋标题:</span><input type="text" name="h_title" style="width:250px;" maxlength="50"><span id="h_title"></span></p>
            	<p><span class="in_span1">房屋关键字:</span><input type="text" name="h_tag" style="width:250px;" maxlength="50"><span id="h_tag"></span></p>
