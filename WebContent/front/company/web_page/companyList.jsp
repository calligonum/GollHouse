        ...
        <div class="b_middle">
        	<div class="middle_title">
               <ul class="middle_title_ul">
                    ...
                    <li id="company" onmouseover="mousemove(this)" onmouseout="mouseout(this)">中介公司</li><li id="border_5"></li>
            ...
            <div class="middle_left">
            	<div style="width:100%;height:auto;">
            		<h2 style="width:100%;height:30px;border-bottom:2px solid rgb(0, 72, 180)">公司列表</h2>
            		<div style="width:100%;height:auto;">
            			<c:forEach items="${requestScope.companyList}" var="company">
	            			<div style="width:90%;height:80px;margin-top:10px;margin-left:10px;" class="companys">
	            				<img src="${pageContext.request.contextPath}/${company.c_img}" style="width:120px;height:80px;float:left;"/>
	            				<div style="width:400px;height:80px;float:left;margin-left:10px;">
	            					<ul style="list-style:none;padding-left:10px;line-height:25px;font-size:17px;">
	            						<li><a href="${pageContext.request.contextPath}/FrontHouses?method=queryCompany&c_id=${company.c_id}&typeName=${company.c_name}">${company.c_name}</a></li>
	            						<li>${company.c_complete_year}</li>
	            						<li>${company.c_address}</li>
	            					</ul>            				
	            				</div>
	            			</div>
            			</c:forEach>
            		...
            		<div class="table_buttom" id="pageres" style="display:none;clear: both;">
						<div class="buttom_left">找到<span id="count">${requestScope.pages.counts}</span>条公司，当前第 ${requestScope.pages.currentPage}/${requestScope.pages.pageCount} 页</div>
		   				 <div class="buttom_right">
		      				<a href="${pageContext.request.contextPath}/Companys?method=selForFront&page=1"><input type="button" value="首页"></a>
		        			<a href="${pageContext.request.contextPath}/Companys?method=selForFront&page=${requestScope.pages.currentPage-1}"><input type="button" value="上一页"/></a>
		      				 <a href="${pageContext.request.contextPath}/Companys?method=selForFront&page=${requestScope.pages.currentPage+1}"><input type="button" value="下一页"/></a>      
		        			<a href="${pageContext.request.contextPath}/Companys?method=selForFront&page=${requestScope.pages.pageCount}"><input type="button" value="尾页"/></a>
				          </div>
				     </div>
            	</div>
