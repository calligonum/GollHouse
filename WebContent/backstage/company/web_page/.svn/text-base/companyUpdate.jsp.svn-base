...
<html>
  <head>
	...
	<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/backstage/company/css/companyUpdate.css" />
  </head>
  <script type="text/javascript"  src="${pageContext.request.contextPath}/js/jquery-1.9.0.js"></script>
  <body> 
  	<div class="main">
      <form action="${pageContext.request.contextPath}/login.do?method=update" method="post">
      	<div class="content">
      		<ul class="title">
      			<li>公司名称:</li>
      			<li>公司年限:</li>
